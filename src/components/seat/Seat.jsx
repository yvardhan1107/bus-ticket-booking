...
const BusSeatLayout=()=>{
    ...
    const handleSeatClick=(seatNumber)=>{   
        if(selectedSeats.includes(seatNumber)){ setSelectedSeats(selectedSeats.filter(seat=>seat!==seatNumber));
        }
        else{
        ...
        <div className="space-y-5">
            ...
            <div className="w-full flex justify-between">
                <div className="flex-1 w-full flex">
                    <div className="w-full flex-1 flex gap-x-5 items-strecth ">
                ...
                <div className="space-y-3 w-28">
                    ...
                    <div className="flex items-center gap-x-2">
                     ...
                     <div className="flex items-center gap-x-2">
                        <RiMoneyCircleLine className='text-lg text-neutral-500 ' />
                      <p className="text-neutral-200 text-sm font-normal">
                       Rs.750
                      </p>
                    </div>
               ...
               <div className="!mt-10">
                   ...
                   <div className="flex flex-wrap">
                       {selectedSeats.map(seat=>(
                        <div className="w-10 h-10 rounded-md m-1.5 text-lg font-medium bg-violet-600/30 flex items-center justify-center text-violet-600">
                            {seat}
                        </div>
                       ))}
                   </div>
